...
def dessiner_pendu(erreurs):
    pendu_images = [
        pygame.image.load("img/pendu1.png"),
        pygame.image.load("img/pendu2.png"),
        pygame.image.load("img/pendu3.png"),
        pygame.image.load("img/pendu4.png"),
        pygame.image.load("img/pendu5.png"),
        pygame.image.load("img/pendu6.png"),
        pygame.image.load("img/pendu7.png"),
    ]
...
def afficher_menu():
    ...
    quitter_texte = police_menu.render("2. Quitter", True, black)
